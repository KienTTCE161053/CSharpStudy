...
namespace AutomobileLibrary.DataAccess
{
    internal class CarDBContext : BaseDAL
    {
        ...
        public IEnumerable<Car> GetCarList()
        {
            ...
            string SQLSelect = "Select CarID, CarName, Manufacturer,  Price, ReleasedYear form Cars";
            ...
            try
            {
                ...
                while (dataReader.Read())
                {
                    cars.Add(new Car
                    {
                        ...
                        ReleaseYear = dataReader.GetInt32(5)
        ...
        public Car GetCarByID(int carID)
        {
            Car car = null;
            IDataReader dataReader = null;
            string SQLSelect = "Select CarID, CarName, Manufacturer,  Price, ReleasedYear form Cars Where CarID = @CarID";
            var cars = new List<Car>();
            try
            {
        ...
        public void AddNew(Car car)
        {
            try
            {
                ...
                if (pro != null)
                {
                    ...
                    parameters.Add(dataProvider.CreateParameter("@Released", 4, car.ReleaseYear, DbType.Int32));
        ...
        public void Update(Car car)
        {
            try
            {
                ...
                if (c != null)
                {
                    string SqlUpdate = "Update Cars set CarID = @CarID,CarName = @CarName,Manufacturer = @Manufacturer,Price = @Price,ReleaseYear = @ReleaseYear)";
                    var parameters = new List<SqlParameter>(); 
                    parameters.Add(dataProvider.CreateParameter("@CarID", 4, car.CarID, DbType.Int32));
                    parameters.Add(dataProvider.CreateParameter("@CarName", 50, car.CarName, DbType.String));
                    parameters.Add(dataProvider.CreateParameter("@Manufacturer", 50, car.Manufacturer, DbType.String));
        ...
        public void Remove(int carID)
        {
            try
            {
                ...
                if (car != null)
                {
                    ...
                    var parameters = dataProvider.CreateParameter("@CarId", 4 , car.CarID, DbType.Int32);
                    dataProvider.Delete(SqlUpdate, CommandType.Text, parameters);
                }
                else
                {
                    throw new Exception("The car does not already exist.");
